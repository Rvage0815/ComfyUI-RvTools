...
class RvText_MergeStringsLarge:
    def __init__(self):
        pass
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "string_6": (any, {"default": ""}),
                "string_7": (any, {"default": ""}),
                "string_8": (any, {"default": ""}),
                "string_9": (any, {"default": ""}),
                "string_10": (any, {"default": ""}),
...
NODE_CLASS_MAPPINGS = {
   NODE_NAME: RvText_MergeStringsLarge
}
